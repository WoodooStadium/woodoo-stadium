      ...
      <section className="hero-bleed">
        <div className="hero-bleed__media">
          <Image
            ...
            alt="Stadium 11-11 — brandet scoringsslider med LED"
            fill
            sizes="100vw"
            priority
      ...
      <section style={{ background: "#E6E3DA", padding: "120px 48px" }}>
        <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
          <div style={{ marginBottom: "48px" }}>
            <span style={{ fontFamily: "var(--mono)", fontSize: "11px", letterSpacing: "0.28em", textTransform: "uppercase", color: "rgba(26,24,20,0.4)", display: "block", marginBottom: "16px" }}>N°04 — Passivt vs. Aktivt</span>
